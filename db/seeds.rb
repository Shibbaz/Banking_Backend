...
Transaction.create!(sender_id: 1000, receiver_id: first.id, amount: 100000, currency: "USD")
Transaction.create!(sender_id: 1000, receiver_id: second.id, amount: 100000, currency: "USD")
