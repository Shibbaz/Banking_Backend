...
RSpec.describe Contexts::Transactions::Repository, type: :model do
  ...
  let(:extraTransaction) {
    Transaction.new(sender: 1000, receiver: extraUser.id, amount: 1000.0)
  }
  before do
    transaction.save!
    extraTransaction.save!
  end
